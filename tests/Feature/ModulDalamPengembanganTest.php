...
/**
 * Pegawai eksternal dan mahasiswa/outsourcing akan dilayani modul tersendiri
...
class ModulDalamPengembanganTest extends TestCase
{
    ...
    public function test_hanya_pegawai_eksternal_dan_outsourcing_yang_modulnya_belum_tersedia(): void
    {
        foreach (PeranPengguna::cases() as $peran) {
            $ditahan = in_array($peran, [PeranPengguna::PegawaiEksternal, PeranPengguna::Outsourcing], true);
    ...
    {
        foreach ([PeranPengguna::PegawaiEksternal, PeranPengguna::Outsourcing] as $peran) {
    ...
    {
        $pengguna = $this->pengguna(PeranPengguna::Outsourcing);
