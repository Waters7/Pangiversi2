    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-4 mb-5">
        <div class="flex flex-col sm:flex-row gap-3">
            ...
            <div class="relative flex-1">
                ...
                <input type="text" placeholder="Cari kegiatan, tujuan..."
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="hover:bg-slate-50/60 transition">
                        ...
                        <td class="px-4 py-4">
                            <p class="text-sm font-semibold text-slate-700">Ahmad Fauzi</p>
                            <p class="text-xs text-slate-400">Sub Bagian Keuangan</p>
                        </td>

                        <td class="px-4 py-4">
                            <p class="text-sm text-slate-700">Rapat Koordinasi Nasional</p>
